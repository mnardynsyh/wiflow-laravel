...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500">Buat akun baru untuk administrator atau teknisi lapangan.</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="px-6 py-4 bg-slate-50 border-b border-slate-100 flex items-center gap-2">
            ...
            <h3 class="font-bold text-slate-800">Formulir User Baru</h3>
        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="role" id="role" class="w-full rounded-lg border-slate-300 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white py-2.5 pl-4 pr-10 text-slate-700 cursor-pointer">
                                ...
                                <option value="teknisi" {{ old('role') == 'teknisi' ? 'selected' : '' }}>Teknisi Lapangan</option>
                            </select>
                        ...
                        <p class="text-xs text-slate-500 mt-1">
                            Admin memiliki akses penuh, Teknisi hanya akses tugas lapangan.
                        </p>
                        @error('role') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>

                    {{-- Spacer agar grid seimbang --}}
                    ...
                    <div class="lg:col-span-2 pt-6 border-t border-slate-100 mt-2">
                        <div class="bg-blue-50 p-4 rounded-lg border border-blue-100 mb-6 flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-semibold text-blue-800">Keamanan Akun</h4>
                                <p class="text-xs text-blue-600 mt-1">
                                    Password default diperlukan untuk login pertama kali. Pengguna dapat mengubahnya nanti.
                                </p>
                            </div>
                        </div>
